...
void D3D9Primitives::RenderRectangle(const Matrix4 &viewPerspective, const Rectangle3f &rect, RGBColor color)
{
    Matrix4 scale = Matrix4::Scaling(rect.Dimensions());
    Matrix4 translate = Matrix4::Translation(rect.Center());
    Matrix4 world = scale * translate;
