//
// Code from http://jgt.akpeters.com/papers/Moller97/tritri.html
//
...
bool Math::TriangleIntersectTriangle(const Vec3f &t0v0, const Vec3f &t0v1, const Vec3f &t0v2, const Vec3f &t1v0, const Vec3f &t1v1, const Vec3f &t1v2)
{
    return (NoDivTriTriIsect((float*)&t0v0, (float*)&t0v1, (float*)&t0v2, (float*)&t1v0, (float*)&t1v1, (float*)&t1v2) == 1);
}