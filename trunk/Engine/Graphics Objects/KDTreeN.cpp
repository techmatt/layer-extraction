...
void KDTree::BuildTree(const Vector<const double*> &Points, UINT Dimension, UINT MaxK)
{
...
void KDTree::BuildTree(const Vector<const float*> &Points, UINT Dimension, UINT MaxK)
{
    UINT PointCount = Points.Length();
    _Dimension = Dimension;
    _MaxK = MaxK;
